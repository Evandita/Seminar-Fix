...
% Numbering untuk table, equation, dan algorithm berdasarkan section
...
% Format section
\titleformat{\section}{\normalfont\fontsize{18}{15}\bfseries\centering}{}{0em}{}
...
Penelitian ini dirancang untuk menguji hipotesis utama secara empiris melalui eksperimen terkontrol yang menggunakan metrik kuantitatif dan \textit{statistical testing} yang rigor.
